          ...
          children: [
            {
              ...
              component: () => import("@/views/modules/backend/sub_category/index.vue")
            },
            {
              path: 'create',
              name: 'admin.subcategories.create',
              component: () => import("@/views/modules/backend/sub_category/create.vue")
            },
            {
              path: ':id/edit',
              name: 'admin.subcategories.edit',
              component: () => import("@/views/modules/backend/sub_category/edit.vue")
            }
          ]
        }
      ]
