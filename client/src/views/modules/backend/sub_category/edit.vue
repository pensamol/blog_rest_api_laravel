<script setup lang="ts">
    ...
    const handleUpdateSubCategory = async() => {
        await adminSubCategoryStore.onUpdateSubCategory()
    }
    onMounted(async() => {
        await adminCategoryStore.fetchCategories()
        await adminSubCategoryStore.fetchSubCategory()
    })
</script>
...
<template>
    <div class="relative overflow-x-auto sm:rounded-lg">
       ...
       <div class="form">
            <form method="post" @submit.prevent="handleUpdateSubCategory">
                <div class="grid md:grid-cols-1 md:gap-6">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="name" v-model="adminSubCategoryStore.getSubCategory.name" id="name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div class="grid md:grid-cols-1 md:gap-6">
                    <div class="relative z-0 w-full mb-5 group">
                        ...
                        <select id="category_id" v-model="adminSubCategoryStore.getSubCategory.category_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
